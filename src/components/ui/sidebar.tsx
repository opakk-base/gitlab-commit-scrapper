...
>(
  (
    ...
    const isMobile = false // Electron is not mobile
  ...
  (
    ...
    return (
      <>
        ...
        >
          <div
            className={cn(
              ...
              "md:group-data-[side=right]:rotate-180",
        ...
        <div
          className={cn(
            "fixed inset-0 z-50 hidden md:hidden",
            openMobile && "block"
          )}
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-50 w-[--sidebar-width] bg-sidebar transition-transform duration-200 ease-linear md:hidden",
